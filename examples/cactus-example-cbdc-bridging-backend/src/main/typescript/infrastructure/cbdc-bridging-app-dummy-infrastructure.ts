...
export class CbdcBridgingAppDummyInfrastructure {
  ...
  public async createSATPGateways(): Promise<void> {
    ...
    await this.besuAEnvironment.giveRoleToBridge(this.besuAGatewayApproveAddress);
    await this.besuBEnvironment.giveRoleToBridge(this.besuBGatewayApproveAddress);
